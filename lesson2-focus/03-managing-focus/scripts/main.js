...
page("/:slug", function (context) {
  ...
  // If this is the first site visit, don't move focus
  // Wait until a menu item is clicked
  if (isFirstPage) {
    isFirstPage = false;
    return;
  }

  // Move the focus to the heading of the corresponding section of the page
